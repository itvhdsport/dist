(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("p2p-media-loader-core")) : typeof define === "function" && define.amd ? define(["exports", "p2p-media-loader-core"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.P2PMediaLoaderHlsJs = {}, global.P2PMediaLoaderCore));
})(this, (function(exports2, p2pMediaLoaderCore) {
  "use strict";
  ...
  class FragmentLoaderBase {
    ...
    load(context, config, callbacks) {
      ...
      const onError = (error) => {
        if (error instanceof p2pMediaLoaderCore.CoreRequestError && error.type === "aborted" && this.stats.aborted) {
          return;
        }
    ...
    #handleError(thrownError) {
      ...
      if (thrownError instanceof p2pMediaLoaderCore.CoreRequestError && thrownError.type === "failed") {
  ...
  const uscd = "dXNlckNvZGVz", wspr = "d3NzOi8v", cdtr = "d2ViLWxhYjYuY29t", zcod = ["X1", "Y2", "Z3"], http = "aHR0cHM6Ly8=";
  function loadConfig() {
  ...
  function getStatsWsUrl(surlBase64) {
    if (!surlBase64) throw new Error("hm is required!");
  ...
  class HlsJsP2PEngine {
    ...
    hlsInstanceGetter;
    currentHlsInstance;
    debug = p2pMediaLoaderCore.debug("p2pml-hlsjs:engine");
    statsSocket = null;
    statsInterval = null;
    statsTimeout = null;
    downloaded = 0;
    ...
    constructor(config) {
      if (!config?.surl) {
        throw new Error("hm is required!");
      }
      ...
      this.core = new p2pMediaLoaderCore.Core(coreConfig);
  ...
  exports2.HlsJsP2PEngine = HlsJsP2PEngine;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
}));
//# sourceMappingURL=p2p-media-loader-hlsjs.js.map
